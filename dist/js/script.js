...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var postData = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, data) {
      var res;
  ...
  var slides = document.querySelectorAll('.offer__slide'),
      ...
      current = document.querySelector('#current'); // Variant 1
  // let slideIndex = 1;
  // if (slides.length < 10) {
  ...
  //     plusSlides(1);
  // });
  // Variant 2 + added .offer__slider-inner

  var slidesWrapper = document.querySelector('.offer__slider-wrapper'),
